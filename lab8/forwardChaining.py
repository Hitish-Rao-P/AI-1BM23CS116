...
rules = [
    ...
    ("Pompeian(x)", "Roman(x)"),     # All Pompeians are Romans

    ("Roman(x)", "Loyal(x)"),        # All Romans are loyal

    ("Man(x)", "Person(x)"),         # All men are persons

    ("Person(x)", "Mortal(x)")       # All persons are mortal
